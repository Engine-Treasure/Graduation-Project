...
from statistics import duration_frequencies as duration_frequencies
from statistics import new_pitch_frequencies_ls as pitch_frequencies
...
def gen_pitch(_min=9, _max=96, p=pitch_frequencies):
    """
    ...
    """
    pitch = Note().from_int(np.random.choice(range(_min, _max + 1), p=p))
...
def gen_duration(_min=32, _max=1, p=duration_frequencies):
    """
